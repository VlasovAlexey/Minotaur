...
function compass_upd(compass_data){
	...
	if (getOS() == "Android") {
		...
		cross_01.style.transform = "rotate(" + (heading + rot_dif) + "deg)"
		cross_02.style.transform = "rotate(" + (heading + rot_dif) + "deg)"
	} else {
		//ios
		labelAngle = (Math.abs(360 - heading));
		dial.style.transform = "rotate(" + (heading - 360) + "deg)"
		acHeading = (Math.abs(360 - Math.round(heading)));
		cross_01.style.transform = "rotate(-" + (heading + 360) + "deg)"
		cross_02.style.transform = "rotate(-" + (heading + 360) + "deg)"
