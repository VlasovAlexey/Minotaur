	...
	! function(t) {
		...
		var e = n(25),
			...
			s = function(t) {
				...
				return function(p, v, g, d) {
					for (var y, x, m = i(p), b = o(m), S = e(v, g, 3), w = u(b.length), E = 0, j = d || a, O = r ? j(p, w) : n ? j(p, 0) : void 0; w > E; E++)
		...
		t.exports = function(t, r, n, g, d) {
			...
			if (i(t, "function" != typeof y || !(d || x.forEach && !l(function() {
				...
				})).prototype = x, x.constructor = m), (O || I) && (w("delete"), w("has"), g && w("get")), (I || j) && w(b), d && x.clear && delete x.clear
			}
			return S[t] = m, e({
				global: !0,
				forced: m != y
		...
		t.exports = function(t, r, n, f, p, x, m) {
			...
			var b, S, w, E = function(t) {
				...
				R = !g && I || E(p),
				k = "Array" == r && A.entries || I;
			if (k && (b = i(k.call(new t)), v !== Object.prototype && b.next && (l || i(b) === v || (u ? u(b, v) : "function" != typeof b[d] && c(b, d, y)), a(b, j, !0, !0), l && (h[j] = y))), "values" == p && I && "values" !== I.name && (O = !0, R = function() {
					return I.call(this)
				}), l && !m || A[d] === R || c(A, d, R), h[r] = R, p)
				if (S = {
						values: E("values"),
						keys: x ? R : E("keys"),
						entries: E("entries")
					}, m)
					for (w in S) !g && !O && w in A || s(A, w, S[w]);
				else e({
					target: r,
					proto: !0,
					forced: g || O
		...
		p && v || (p = function(t) {
			...
			y.now(S(t))
		} : d ? (i = (o = new d).port2, o.port1.onmessage = w, e = s(i.postMessage, i, 1)) : !u.addEventListener || "function" != typeof postMessage || u.importScripts || a(E) ? e = "onreadystatechange" in l("script") ? function(t) {
			f.appendChild(l("script")).onreadystatechange = function() {
				f.removeChild(this), b(t)
			}
		} : function(t) {
			setTimeout(S(t), 0)
		} : (e = E, u.addEventListener("message", w, !1))), t.exports = {
			set: p,
			clear: v
		}
	}, function(t, r, n) {
			...
			U = function() {
				...
				if (x(this, {
					...
					if (v(a))
						...
						else P(c, "string" == typeof a ? "?" === a.charAt(0) ? a.slice(1) : a : a + "")
			},
			F = U.prototype;
		u(F, {
			append: function(t, r) {
		...
		if (i("Number", !y(" 0o1") || !y("0b1") || y("+0x1"))) {
			for (var S, w = function(t) {
				...
				}, E = e ? p(y) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger".split(","), j = 0; E.length > j; j++) a(y, S = E[j]) && !a(w, S) && g(w, S, v(y, S));
		...
		var e, o, i, u = n(0),
			...
			D = B,
			W = "process" == d(M),
			G = !!(T && T.createEvent && c.dispatchEvent),
			$ = R(P, function() {
				var t = U.resolve(1),
					r = function() {},
				...
				return !((W || "function" == typeof PromiseRejectionEvent) && (!a || t.finally) && t.then(r) instanceof n && 0 !== q.indexOf("6.6") && -1 === A.indexOf("Chrome/66"))
			}),
			X = $ || !x(function(t) {
					...
					S(function() {
						for (var o = r.value, i = 1 == r.state, u = 0; e.length > u;) {
							var a, c, s, f = e[u++],
								...
								v = f.domain;
							try {
								l ? (i || (2 === r.rejection && Z(t, r), r.rejection = 1), !0 === l ? a = o : (v && v.enter(), a = l(o), v && (v.exit(), s = !0)), a === f.promise ? p(F("Promise-chain cycle")) : (c = V(a)) ? c.call(a, h, p) : h(a)) : p(o)
							} catch (t) {
								v && !s && v.exit(), p(t)
							}
						}
						r.reactions = [], r.notified = !1, n && !r.rejection && K(t, r)
					})
				}
			},
			Y = function(t, r, n) {
				var e, o;
				G ? ((e = T.createEvent("Event")).promise = r, e.reason = n, e.initEvent(t, !1, !0), c.dispatchEvent(e)) : e = {
					promise: r,
					reason: n
				}, (o = c["on" + t]) ? o(e) : "unhandledrejection" === t && E("Unhandled promise rejection", n)
			},
			K = function(t, r) {
				b.call(c, function() {
					var n, e = r.value;
					if (Q(r) && (n = O(function() {
							W ? M.emit("unhandledRejection", e, t) : Y("unhandledrejection", t, e)
						}), r.rejection = W || Q(r) ? 2 : 1, n.error)) throw n.value
				})
			},
			Q = function(t) {
			...
			Z = function(t, r) {
				b.call(c, function() {
					W ? M.emit("rejectionHandled", t) : Y("rejectionhandled", t, r.value)
				})
			},
			H = function(t, r, n, e) {
				return function(o) {
			...
			tt = function(t, r, n, e) {
				r.done || (r.done = !0, e && (r = e), r.value = n, r.state = 2, J(t, r, !0))
			},
			rt = function(t, r, n, e) {
				if (!r.done) {
					r.done = !0, e && (r = e);
					try {
						...
						o ? S(function() {
							...
							try {
								o.call(n, H(rt, t, e, r), H(tt, t, e, r))
							} catch (n) {
								tt(t, e, n, r)
							}
						}) : (r.value = n, r.state = 1, J(t, r, !1))
					} catch (n) {
						tt(t, {
							done: !1
						}, n, r)
		...
		$ && (U = function(t) {
			g(this, U, P), v(t), e.call(this);
			var r = _(this);
			try {
				t(H(rt, this, r), H(tt, this, r))
			} catch (t) {
				tt(this, r, t)
			}
		}, (e = function(t) {
			...
			then: function(t, r) {
				var n = N(this),
					e = B(m(this, U));
				return e.ok = "function" != typeof t || t, e.fail = "function" == typeof r && r, e.domain = W ? M.domain : void 0, n.parent = !0, n.reactions.push(e), 0 != n.state && J(this, n, !1), e.promise
			},
			catch: function(t) {
			...
			var t = new e,
				r = _(t);
			this.promise = t, this.resolve = H(rt, t, r), this.reject = H(tt, t, r)
		}, j.f = B = function(t) {
			return t === U || t === i ? new o(t) : D(t)
		}, a || "function" != typeof z || u({
			global: !0,
			enumerable: !0,
			forced: !0
		}, {
			fetch: function(t) {
				return w(U, z.apply(c, arguments))
			}
		})), u({
			global: !0,
			wrap: !0,
		...
		b || (e = function() {
			...
			d.nextTick(e)
		} : g && !/(iphone|ipod|ipad).*applewebkit/i.test(v) ? (a = !0, c = document.createTextNode(""), new g(e).observe(c, {
			characterData: !0
		}), u = function() {
			c.data = a = !a
		...
		e("replace", 2, function(t, r, n) {
			return [function(n, e) {
				...
				for (var b, S = "", w = 0, E = 0; E < x.length; E++) {
					m = x[E];
					for (var j = String(m[0]), O = l(h(a(m.index), v.length), 0), A = [], I = 1; I < m.length; I++) A.push(void 0 === (b = m[I]) ? b : String(b));
					var R = m.groups;
					if (g) {
						var k = [j].concat(A, O, v);
						void 0 !== R && k.push(R);
						var P = String(i.apply(void 0, k))
					} else P = e(j, v, O, A, R, i);
					O >= w && (S += v.slice(w, O) + P, w = O + j.length)
				}
				return S + v.slice(w)
			}];
		...
		e("split", 2, function(t, r, n) {
			...
			return e = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function(t, n) {
				...
				for (var b = 0, S = 0, w = []; S < h.length;) {
					x.lastIndex = g ? S : 0;
					var E, j = f(x, g ? h : h.slice(S));
					if (null === j || (E = v(s(x.lastIndex + (g ? 0 : S)), h.length)) === b) S = c(h, S, d);
					else {
						if (w.push(h.slice(b, S)), w.length === m) return w;
						for (var O = 1; O <= j.length - 1; O++)
							if (w.push(j[O]), w.length === m) return w;
						S = b = E
					}
				}
		...
		var e, o = n(0),
			...
			M = function(t, r) {
				...
				if ("[" == r.charAt(0)) {
					...
					for (n = "", e = p(r), o = 0; o < e.length; o++) n += $(e[o], B);
					t.host = n
				}
			},
			z = function(t) {
				...
				for (n = [], e = 0; e < r; e++) {
					...
					if (i = 10, o.length > 1 && "0" == o.charAt(0) && (i = k.test(o) ? 16 : 8, o = o.slice(8 == i ? 1 : 2)), "" === o) u = 0;
						...
						if (!(10 == i ? _ : 8 == i ? P : L).test(o)) return t;
						u = parseInt(o, i)
					}
					n.push(u)
				}
			...
			q = function(t) {
				var r, n, e, o;
				if ("number" == typeof t) {
					for (r = [], n = 0; n < 4; n++) r.unshift(t % 256), t = j(t / 256);
					return r.join(".")
				}
				if ("object" == typeof t) {
					for (r = "", e = function(t) {
			...
			K = function(t, r) {
				var n;
				return 2 == t.length && A.test(t.charAt(0)) && (":" == (n = t.charAt(1)) || !r && "|" == n)
			},
			Q = function(t) {
				var r;
				return t.length > 1 && K(t.slice(0, 2)) && (2 == t.length || "/" === (r = t.charAt(2)) || "\\" === r || "?" === r || "#" === r)
			},
			Z = function(t) {
				var r = t.path,
					n = r.length;
			...
			St = function(t, r, n, o) {
				var i, u, a, c, s, f = n || tt,
					...
					d = !1,
					y = !1;
				for (n || (t.scheme = "", t.username = "", t.password = "", t.host = null, t.port = null, t.path = [], t.query = null, t.fragment = null, t.cannotBeABaseURL = !1, r = r.replace(F, "")), r = r.replace(T, ""), i = p(r); h <= i.length;) {
					switch (u = i[h], f) {
						case tt:
							if (!u || !A.test(u)) {
						...
						case rt:
							if (u && (I.test(u) || "+" == u || "-" == u || "." == u)) v += u.toLowerCase();
								...
								v = "", "file" == t.scheme ? f = pt : V(t) && o && o.scheme == t.scheme ? f = et : V(t) ? f = at : "/" == i[h + 1] ? (f = ot, h++) : (t.cannotBeABaseURL = !0, t.path.push(""), f = xt)
							}
							break;
						case nt:
						...
						case pt:
							if (t.scheme = "file", "/" == u || "\\" == u) f = vt;
								...
								if (u == e) t.host = o.host, t.path = o.path.slice(), t.query = o.query;
									...
									if ("#" != u) {
										Q(i.slice(h).join("")) || (t.host = o.host, t.path = o.path.slice(), Z(t)), f = yt;
										continue
									}
						...
						case vt:
							...
							o && "file" == o.scheme && !Q(i.slice(h).join("")) && (K(o.path[0], !0) ? t.path.push(o.path[0]) : t.host = o.host), f = yt;
							continue;
						case gt:
							if (u == e || "/" == u || "\\" == u || "?" == u || "#" == u) {
								if (!n && K(v)) f = yt;
						...
						case yt:
							if (u == e || "/" == u || "\\" == u && V(t) || !n && ("?" == u || "#" == u)) {
								if (".." === (s = (s = v).toLowerCase()) || "%2e." === s || ".%2e" === s || "%2e%2e" === s ? (Z(t), "/" == u || "\\" == u && V(t) || t.path.push("")) : H(v) ? "/" == u || "\\" == u && V(t) || t.path.push("") : ("file" == t.scheme && !t.path.length && K(v) && (t.host && (t.host = ""), v = v.charAt(0) + ":"), t.path.push(v)), v = "", "file" == t.scheme && (u == e || "?" == u || "#" == u))
			...
			wt = function(t) {
				...
				}, i || (e.href = jt.call(e), e.origin = Ot.call(e), e.protocol = At.call(e), e.username = It.call(e), e.password = Rt.call(e), e.host = kt.call(e), e.hostname = Pt.call(e), e.port = _t.call(e), e.pathname = Lt.call(e), e.search = Nt.call(e), e.searchParams = Ut.call(e), e.hash = Ft.call(e))
			},
			Et = wt.prototype,
			jt = function() {
				var t = E(this),
		...
		if (i && c(Et, {
				...
				origin: Tt(Ot),
				protocol: Tt(At, function(t) {
					var r = E(this);
					St(r, String(t) + ":", tt)
				}),
				username: Tt(It, function(t) {
					var r = E(this),
						n = p(String(t));
					if (!Y(r)) {
						r.username = "";
				...
				hostname: Tt(Pt, function(t) {
					var r = E(this);
					r.cannotBeABaseURL || St(r, String(t), lt)
				}),
				port: Tt(_t, function(t) {
					var r = E(this);
 ...
 */
! function() {
	var e, n = "undefined" != typeof self,
		t = n ? self : global;
	if ("undefined" != typeof location) {
		var r = (e = location.href.split("#")[0].split("?")[0]).lastIndexOf("/"); - 1 !== r && (e = e.slice(0, r + 1))
	}
	var i = /\\/g,
			...
			var n = function e(n, t, r) {
				...
				var l = Promise.resolve().then(function() {
						...
						var r = e[1](function(e, n) {
							i.h = !0;
							var t = !1;
							if ("object" != typeof e) e in c && c[e] === n || (c[e] = n, t = !0);
							else
								for (var r in e) {
									var u = e[r];
							...
							if (t)
								for (var f = 0; f < o.length; f++) o[f](c);
							return n
						}, 2 === e[1].length ? {
							import: function(e) {
								return n.import(e, t)
	...
	var a, d = Object.freeze(Object.create(null));
	t.System = new c, "undefined" != typeof window && window.addEventListener("error", function(e) {
		a = e.error
	});
	var v = s.register;
	s.register = function(e, n) {
	...
	}, n && "function" == typeof importScripts && (s.instantiate = function(e) {
		var n = this;
		...
		var r = function(e, n) {
			if (-1 !== e.indexOf("\\") && (e = e.replace(i, "/")), "/" === e[0] && "/" === e[1]) return n.slice(0, n.indexOf(":") + 1) + e;
			if ("." === e[0] && ("/" === e[1] || "." === e[1] && ("/" === e[2] || 2 === e.length && (e += "/")) || 1 === e.length && (e += "/")) || "/" === e[0]) {
				var t, r = n.slice(0, n.indexOf(":") + 1);
				if (t = "/" === n[r.length + 1] ? "file:" !== r ? (t = n.slice(r.length + 2)).slice(t.indexOf("/") + 1) : n.slice(8) : n.slice(r.length + ("/" === n[r.length])), "/" === e[0]) return n.slice(0, n.length - t.length - 1) + e;
				for (var o = t.slice(0, t.lastIndexOf("/") + 1) + e, u = [], f = -1, c = 0; c < o.length; c++) - 1 !== f ? "/" === o[c] && (u.push(o.slice(f, c + 1)), f = -1) : "." === o[c] ? "." !== o[c + 1] || "/" !== o[c + 2] && c + 2 !== o.length ? "/" === o[c + 1] || c + 1 === o.length ? c += 1 : f = c : (u.pop(), c += 2) : f = c;
				return -1 !== f && u.push(o.slice(f)), n.slice(0, n.length - t.length) + u.join("")
			}
		}(n, t || e);
		if (!r) {
...
function parseCss(node, text) {
	...
	var r$ = node['rules'];
	if (r$) {
		for (var i = 0, l = r$.length, r = void 0;
			(i < l) && (r = r$[i]); i++) {
			parseCss(r, text);
		}
	}
