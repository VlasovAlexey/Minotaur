...
function showPosition(position) {
	...
	document.getElementById("location-info")
		.innerHTML = convertCoordinates(position.coords.latitude, position.coords.longitude);
	document.getElementById("location-elev")
		.innerHTML = Math.round(position.coords.altitude * 3.280839895) + " ft Elevation";
}
